...
socket_shell::BaseSocket::BaseSocket (int sd): m_Socket(sd) {}
...
struct sockaddr_in socket_shell::ConvertAddress(const char * HostName, short PortNum)
{
...
void socket_shell::BaseSocket::Connect()
{
...
void socket_shell::BaseSocket::Connect(const char * HostName, short PortNum)
{
...
socket_shell::BaseSocket::BaseSocket(const char * HostName, short PortNum)
{
    m_pAddr = ConvertAddress(HostName, PortNum);
...
socket_shell::ServerSocket::ServerSocket(const char * HostName, short PortNum)
{
    m_pAddr = ConvertAddress(HostName, PortNum);
    if ((m_Socket = socket (AF_INET, SOCK_STREAM, 0)) < 0) {
        throw SocketException(SocketException::ESE_SOCKCREATE);
...
socket_shell::BaseSocket socket_shell::ServerSocket::Accept()
{
    ...
    socket_shell::BaseSocket s(d, m_pAddr);
